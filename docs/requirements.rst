...
===============================================
Requirements for medVAE
===============================================

This is the software requirements file for medVAE, part of the
SNAPPY project. The requirements listed below should define
what medVAE does. Each requirement can be matched to a unit test that
